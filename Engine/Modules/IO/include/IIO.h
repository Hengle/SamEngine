...
namespace SamEngine
{
    ...
    public:
        ...
        virtual void Read(const std::string &file, IOCallbackFunction callback) = 0;

        virtual void Write(const std::string &file, const DataPtr &data, IOCallbackFunction callback = nullptr) = 0;
