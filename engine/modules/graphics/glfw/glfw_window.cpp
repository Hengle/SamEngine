...
namespace sam
{
    ...
    void glfw_window::initialize(const graphics_config &config, const graphics_attribute &attribute)
    {
        ...
        glfwWindowHint(GLFW_RED_BITS, channel_bits_of_format(render_target_attribute.color_format, pixel_channel_type::red));
        glfwWindowHint(GLFW_GREEN_BITS, channel_bits_of_format(render_target_attribute.color_format, pixel_channel_type::green));
        glfwWindowHint(GLFW_BLUE_BITS, channel_bits_of_format(render_target_attribute.color_format, pixel_channel_type::blue));
        glfwWindowHint(GLFW_ALPHA_BITS, channel_bits_of_format(render_target_attribute.color_format, pixel_channel_type::alpha));
        glfwWindowHint(GLFW_DEPTH_BITS, channel_bits_of_format(render_target_attribute.depth_format, pixel_channel_type::depth));
        glfwWindowHint(GLFW_STENCIL_BITS, channel_bits_of_format(render_target_attribute.depth_format, pixel_channel_type::stencil));
